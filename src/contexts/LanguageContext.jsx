...
const TRANSLATIONS = {
  fr: {
    ...
    // Testimonials
    t1_name: 'John Moka', t1_role: 'Développeur Fullstack · Collaborateur', t1_project: 'Scholaris & COACKI',
    t1_text: "Travailler avec Lucien sur Scholaris et COACKI a été une expérience remarquable. Il maîtrise aussi bien l'architecture backend que le frontend, et surtout il tient ses engagements. Le code est propre, documenté et livré dans les délais. Je recommande sans hésiter.",
    t2_name: 'Baudouin Katembera', t2_role: 'Directeur · École Primaire St-François', t2_project: 'Scholaris',
    t2_text: "Avant Scholaris, on perdait des bulletins, les absences n'étaient pas suivies et les parents devaient venir physiquement pour avoir des informations. Aujourd'hui tout est centralisé. Le passage au numérique s'est fait en douceur grâce à la formation et à la disponibilité de Lucien.",
    t3_name: 'Esperance Nyakabwa', t3_role: 'Coordinatrice · Umoja ni Nguvu Foundation', t3_project: 'Site institutionnel',
    t3_text: "Notre site reflète enfin l'image professionnelle que nous voulons donner à nos partenaires internationaux. Lucien a compris notre mission dès le premier échange et a livré un site clair, accessible et bien référencé. Le formulaire de contact nous amène déjà de nouveaux partenaires.",
    t4_name: 'Théodore Birhakaheka', t4_role: 'Président · Coopérative COACKI', t4_project: 'Solution de gestion coopérative',
    t4_text: "On gérait tout sur des cahiers et on perdait des données chaque saison. Maintenant on voit en temps réel nos stocks, nos membres actifs et nos ventes. Lucien a pris le temps de comprendre comment on travaille avant de coder quoi que ce soit. C'est ça qui fait la différence.",
    t5_name: 'Patient Muhimuzi', t5_role: 'Fondateur · Dynamique Samy Magadju', t5_project: 'Site ASBL',
    t5_text: "Lucien a créé notre site vitrine en respectant notre identité visuelle et nos valeurs. Il nous a expliqué chaque étape, formé notre équipe pour la mise à jour du contenu. Un vrai partenaire, pas juste un prestataire. Je n'hésiterai pas à faire appel à lui pour nos prochains projets.",
    // Offline & cookies
    offline_title: 'Vous êtes hors ligne',
    offline_msg: "Votre appareil n'est pas connecté à Internet. Veuillez vérifier votre connexion Wi-Fi ou données mobiles, puis réessayez.",
    offline_retry: 'Réessayer',
    cookie_title: 'Nous respectons votre vie privée',
    cookie_desc: 'Ce site utilise des cookies pour améliorer votre expérience. Vous pouvez accepter tous les cookies ou personnaliser vos préférences.',
    cookie_accept_all: 'Tout accepter',
    cookie_configure: 'Paramétrer',
    cookie_save: 'Sauvegarder mes choix',
    cookie_essential: 'Cookies essentiels',
    cookie_essential_desc: 'Nécessaires au fonctionnement du site. Toujours actifs.',
    cookie_analytics: 'Cookies analytiques',
    cookie_analytics_desc: 'Nous aident à comprendre comment vous naviguez sur le site.',
    cookie_marketing: 'Cookies marketing',
    cookie_marketing_desc: 'Utilisés pour personnaliser les publicités et les contenus.',
    cookie_learn_more: 'Politique de confidentialité',
  ...
  en: {
    ...
    t1_name: 'John Moka', t1_role: 'Fullstack Developer · Collaborator', t1_project: 'Scholaris & COACKI',
    t1_text: "Working with Lucien on Scholaris and COACKI was a remarkable experience. He masters both backend architecture and frontend, and above all he keeps his commitments. The code is clean, documented and delivered on time. I recommend him without hesitation.",
    t2_name: 'Baudouin Katembera', t2_role: 'Principal · St-François Primary School', t2_project: 'Scholaris',
    t2_text: "Before Scholaris, we lost report cards, absences weren't tracked and parents had to come in person for information. Today everything is centralized. The switch to digital went smoothly thanks to Lucien's training and availability.",
    t3_name: 'Esperance Nyakabwa', t3_role: 'Coordinator · Umoja ni Nguvu Foundation', t3_project: 'Institutional website',
    t3_text: "Our website finally reflects the professional image we want to give our international partners. Lucien understood our mission from the first conversation and delivered a clear, accessible and well-referenced site. The contact form is already bringing us new partners.",
    t4_name: 'Théodore Birhakaheka', t4_role: 'President · COACKI Cooperative', t4_project: 'Cooperative management solution',
    t4_text: "We managed everything on notebooks and lost data every season. Now we see in real time our stocks, active members and sales. Lucien took the time to understand how we work before writing any code. That is what makes the difference.",
    t5_name: 'Patient Muhimuzi', t5_role: 'Founder · Dynamique Samy Magadju', t5_project: 'NGO Website',
    t5_text: "Lucien created our showcase website respecting our visual identity and values. He explained each step and trained our team to update content. A true partner, not just a service provider. I will not hesitate to call on him for our next projects.",
    offline_title: 'You are offline',
    offline_msg: 'Your device is not connected to the Internet. Please check your Wi-Fi or mobile data connection, then try again.',
    offline_retry: 'Retry',
    cookie_title: 'We respect your privacy',
    cookie_desc: 'This site uses cookies to improve your experience. You can accept all cookies or customize your preferences.',
    cookie_accept_all: 'Accept all',
    cookie_configure: 'Configure',
    cookie_save: 'Save my choices',
    cookie_essential: 'Essential cookies',
    cookie_essential_desc: 'Required for the site to function. Always active.',
    cookie_analytics: 'Analytics cookies',
    cookie_analytics_desc: 'Help us understand how you navigate the site.',
    cookie_marketing: 'Marketing cookies',
    cookie_marketing_desc: 'Used to personalize ads and content.',
