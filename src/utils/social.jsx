// Shared social icons & helpers used across Footer, Contact, Navbar
...
export const WA_MESSAGES = {
  ...
  en: [
    "Hello Lucien, I saw your portfolio and would like to discuss a development project.",
    "Hi Lucien, I'd like to learn more about your custom solutions.",
    "Hello Lucien, I'd like to discuss a collaboration opportunity.",
    "Hello Lucien Amani, I'd like to discuss a web project for my organization.",
    "Hello, I'd like to get a quote for a software development project.",
  ],
}

export function openWhatsApp(lang = 'fr') {
  const msgs = WA_MESSAGES[lang] || WA_MESSAGES.fr
